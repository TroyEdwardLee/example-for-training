sap.ui.define([
	...
	"example/for/trainingexample-for-training/model/formatter",
	"sap/ui/model/Filter",
	...
	return BaseController.extend("example.for.trainingexample-for-training.controller.Worklist", {
		...
		onUpdateStarted: function(oEvent) {
			...
			var aCurrentItem = oSource.getItems();
			/*aCurrentItem.map(function(item) {
				oSource.removeItem(item);
			});*/
		},
